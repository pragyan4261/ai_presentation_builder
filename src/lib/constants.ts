...
//changed the itemvariants and container variants to match the types
...
export const containerVariants: Variants = {
  ...
  visible: {
    ...
    transition: {
      staggerChildren: 0.1,
      when: 'beforeChildren', // optional but recommended for orchestrating children
    },
  },
};
...
export const itemVariants: Variants = {
  ...
  visible: {
    ...
    opacity: 1,
    transition: {
      type: 'spring', // ✅ valid literal type
      stiffness: 100,
    },
  },
};
